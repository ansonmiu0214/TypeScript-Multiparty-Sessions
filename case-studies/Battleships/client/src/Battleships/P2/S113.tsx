 ...
 * * __Sunk__(Location)
 */
export default abstract class S113<ComponentState = {}> extends React.Component<Props, ComponentState>
{
    ...
    handle(message: any): MaybePromise<State> {
        ...
        switch (parsedMessage.label) {
            case Labels.Winner: {
                const thunk = () => TerminalState.S110;
