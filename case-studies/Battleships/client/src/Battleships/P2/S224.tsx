 ...
 * * __Winner__(Location)
 */
export default abstract class S224<ComponentState = {}> extends React.Component<Props, ComponentState>
{
    ...
    handle(message: any): MaybePromise<State> {
        ...
        switch (parsedMessage.label) {
            case Labels.Hit: {
                ...
                const thunk = () => TerminalState.S221;
