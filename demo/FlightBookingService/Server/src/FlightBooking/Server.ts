...
class Session {
    ...
    private initialState: Implementation.S17;
    ...
    constructor(wss: WebSocket.Server,
        ...
        this.activeRoles = new Set([Roles.Peers.Traveller]);
    ...
    restart() {
        new Server(this.wss, this.initialState, this.cancellation);
    }
