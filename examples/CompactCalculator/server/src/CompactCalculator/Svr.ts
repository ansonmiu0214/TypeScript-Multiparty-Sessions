...
export class Svr {
    ...
    constructor(wss: WebSocket.Server,
        initialState: Implementation.S44,
        ...
        wss.addListener('connection', (ws: WebSocket) => {
            console.log('new connection', count, ws.url);
...
class Session {
    ...
    private initialState: Implementation.S44
